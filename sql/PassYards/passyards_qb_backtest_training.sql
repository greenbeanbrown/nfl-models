...
-- WHERE ppos.Position = "QB" AND gi.Season NOT IN (2023,2024)
-- WHERE ppos.Position = "QB" AND ppos.StarterFlag = "Y" AND gi.Season NOT IN (2023,2024)
WHERE ppos.Position = "QB" AND ppas.PassComp > 4 AND ppos.StarterFlag = "Y" AND gi.Season NOT IN (2023,2024)