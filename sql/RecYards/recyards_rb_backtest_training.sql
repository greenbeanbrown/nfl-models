...
SELECT 
    -- Target Variable
    prec.RecYards AS TargetRecYards,
    -- prus.RushAtt AS RushAtt,
    -- player-positions
    ppos.PlayerId,
    ppos.Player,
    ppos.GameDate,
...
-- Used for filtering RushAtt
JOIN player_rushing AS prus
    ON lprec.PlayerId = prus.PlayerId
    AND lprec.Player = prus.Player
    AND lprec.GameDate = prus.GameDate
    AND lprec.TeamAbbr = prus.TeamAbbr
